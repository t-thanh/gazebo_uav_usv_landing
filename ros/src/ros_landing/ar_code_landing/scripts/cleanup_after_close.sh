...
echo "[cleanup] Sending SIGTERM to gzserver, gzclient, px4, mavros rosmaster roslaunch rosout …"
killall -SIGTERM gzserver gzclient px4 mavros mavros_node rosmaster roslaunch rosout 2>/dev/null || true
sleep 0.4
